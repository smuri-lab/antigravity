...
export const TimeSelectorButton: React.FC<TimeSelectorButtonProps> = ({ label, value, placeholder, onClick, disabled }) => {
  return (
    <div>
      ...
      >
        <div className="flex items-center gap-2">
            ...
            <span className={value ? 'text-gray-900 font-mono tracking-wider' : 'text-gray-500'}>
              {value || placeholder}
            </span>
        </div>
