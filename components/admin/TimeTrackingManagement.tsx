                ...
                <Card>
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full bg-white">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-40 min-w-[10rem] max-w-[10rem]">Mitarbeiter</th>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {employeeOverviewStats.map(stat => (
                                    <tr key={stat.id} onClick={() => handleSelectEmployee(stat.id)} className="cursor-pointer hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-4 whitespace-nowrap font-normal w-40 min-w-[10rem] max-w-[10rem] truncate">{stat.name}</td>
