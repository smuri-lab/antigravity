            ...
            <div className="overflow-x-auto min-h-[300px]">
                <table className="min-w-full border-collapse table-fixed">
                    <thead className="sticky top-0 bg-white z-10 shadow-sm">
                        <tr>
                            <th rowSpan={2} className="sticky left-0 bg-white border-b border-r border-gray-200 w-40 min-w-[10rem] max-w-[10rem] z-20 align-bottom pb-2 shadow-[2px_1px_5px_rgba(0,0,0,0.02)]">
