                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full text-sm">
                                <thead className="text-left bg-gray-50 border-b">
                                    <tr>
                                        <th className="py-2 px-3 font-semibold text-gray-600 w-48 min-w-[12rem]">Mitarbeiter</th>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {filteredEntries.map((entry, index) => (
                                        <tr key={index} className="hover:bg-gray-50">
                                            <td className="py-2 px-3 whitespace-nowrap align-top font-medium w-48 min-w-[12rem] truncate">{entry.employeeName}</td>
